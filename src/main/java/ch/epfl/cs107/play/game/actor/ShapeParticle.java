...
public class ShapeParticle implements Graphics, Positionable {
    ...
    // Constructor
    public ShapeParticle(Vector position, Vector velocity, Shape shape, Color fillColor, float alpha, float speed) throws IllegalArgumentException {
    ...
    public void draw(Canvas canvas) {
        canvas.drawShape(shape, Transform.I.translated(position), fillColor, null,0, alpha, 2);
    }
