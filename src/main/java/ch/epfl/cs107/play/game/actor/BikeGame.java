...
public class BikeGame extends ActorGame {
    ...
    private TextGraphics message = new TextGraphics("", 0.25f, new Color(45, 67, 89), null, 0.02f, true, false, new Vector( 0.35f, 0.5f), 1.f, 100.f);
    private TextGraphics resetMessage =  new TextGraphics("Press-ENTER-to-reset", 0.03f, Color.WHITE, null, 0.02f, true, false, new Vector( 0.35f, -5.f), 0.f, 100.f);
    private TextGraphics scoreMessage = new TextGraphics("SCORE :", 0.03f, Color.WHITE, null, 0.02f, true, false, new Vector(1.3f, 13.f), 1.f, 100.f);
    private TextGraphics scoreNumber = new TextGraphics("0000", 0.03f, Color.WHITE, null, 0.02f, true, false, new Vector(0.f, 13.f), 1.f, 100.f);
    ...
    // Method to reset the game (removing, creating all the actors and reseting all the text messages)
    public void reset() {
    ...
    public void update(float deltaTime) {
        ...
        //If the bike gets hit with any other object, ends the game with a Game Over
            ...
            message.setAnchor(new Vector(0.4f, 0.5f));
