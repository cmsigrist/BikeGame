...
public class ScaleGame implements Game {
    ...
    public boolean begin(Window window, FileSystem fileSystem) {
	    ...
	    plankGraphics = new ImageGraphics("src/main/resources/wood.3.png", 5, 0.2f);
	    ...
	    ballGraphics = new ImageGraphics("src/main/resources/explosive.11.png", 2.0f*0.5f, 2.0f*0.5f, new Vector(0.5f, 0.5f));
